  ...
  return (
    <form className='w-[454px] rounded-2xl shadow-md mx-auto my-3 pb-5'>
        ...
        <section className='mt-5 px-9'>
           {/* name section */}
        <div>
          <h3>Full Name<span className='text-red-600'>*</span></h3>
        ...
        <button className='bg-[#015AD8] text-white w-full py-3 rounded-md mt-4'>Join for free</button>
        ...
        <p className='text-center text-gray-400 mt-4'>Already on Eduse? <span className='text-[#015AD8] cursor-pointer underline'>Login</span></p>
        </section>
    </form>
  )
}
