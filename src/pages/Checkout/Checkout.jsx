...
const Checkout = () => {
  ...
  // Store intotal in Redux whenever total changes
  useEffect(() => {
  ...
  const handlePlaceOrder = () => {
    ...
    alert(`Selected ${paymentMethod}. In demo we consider it paid. Total: ${total.toFixed(2)} BDT`);
    navigate("/payment-success", { 
      state: { 
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-6">
              <div className="font-semibold text-lg mb-4">
                Order Items ({selectedCartItems.length} {selectedCartItems.length === 1 ? "item" : "items"})
              </div>
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-4">
                  ...
                  <select 
                    ...
                    onChange={handleInputChange}
                    className="border rounded-lg p-2 w-full font-light"
                    required
                  >
