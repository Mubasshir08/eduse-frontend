 ...
 const [cartItems, setCartItems] = useState([
  ...
  return (
    <>
      {/* Cart Section */}
      {isOpen ? (
        <div className="fixed  xl:right-[34vh] sm:right-0  w-[]70 h-200 bg-white shadow-lg  z-50 overflow-y-auto rounded-md ">
          {/* Header */}
          ...
          <div className="space-y-4 p-4">
            ...
            <div></div>
          {/* Subtotal */}
          <div className="flex justify-between items-center font-medium mt-4 -bottom-70 px-4 relative">
            <span>Subtotal:</span>
            <span>BDT {subtotal}</span>
          </div>

          {/* Buttons */}
          <div className="mt-6 space-y-2 relative -bottom-67 px-4">
